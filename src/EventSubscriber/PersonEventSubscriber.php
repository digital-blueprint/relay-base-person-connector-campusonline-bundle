...
class PersonEventSubscriber extends AbstractLocalDataEventSubscriber
{
    ...
    public const USERNAME_SOURCE_ATTRIBUTE = 'username';
    public const STUDIES_SOURCE_ATTRIBUTE = 'studies';
    ...
    protected function getAttributeValue(LocalDataPostEvent $postEvent, array $attributeMapEntry): mixed
    {
        ...
        switch ($attributeMapEntry[self::SOURCE_ATTRIBUTE_KEY]) {
            ...
            case self::USERNAME_SOURCE_ATTRIBUTE:
                return $this->personProvider->getUserResourceFromApiCached($personIdentifier)?->getUsername(0);
            case self::STUDIES_SOURCE_ATTRIBUTE:
                return $this->personProvider->getStudiesFromApiCached($personIdentifier, $postEvent->getOptions());
        }
